...
const Project = ({ data, index }: ProjectProps) => {
	...
	return (
		<motion.div
			...
			className="relative sm:w-[350px] w-full h-max border border-yellow-400 rounded-lg cursor-pointer"
		>
			<Image
				src={data.url}
				alt="Project Image"
			...
			<motion.div
				...
				className="absolute top-0 w-full h-full flex flex-col items-center justify-center gap-y-2 bg-white/95 p-6 rounded-lg dark:bg-zinc-700/95 transition-colors select-none"
			>
